						...
						<div class="w3-card w3-round w3-white">
							<div class="w3-container w3-padding">
								<h6 class="w3-opacity">Search Results..</h6>
									patit.pawan@capgemini.com <br>
										<form action="getFriendProfile" method="post">
					                          <input type="hidden" name="friendProfileId" value="patit.pawan@capgemini.com">
										...
										<form action="/sendFriendRequest" method="post">
										    <input type="hidden" name="receiverId" value="patit.pawan@capgemini.com">
								...
								<h6 class="w3-opacity">Search Results..</h6>
									${searchResult} <br>
										<form action="getFriendProfile" method="post">
					                          ...
					                          <button type="submit" class="w3-button w3-theme-d1 w3-margin-bottom">GO TO PROFILE
               								</button>
               							</form>
